package org.example.example.e30;
...
public class E30ScannerClass {
    public static void main(String[] args) {
        ...
        System.out.println("Please enter the month number");                // Print prompt for user to input the month number
        int monthNumber = input.nextInt();                                  // Capture the month number
