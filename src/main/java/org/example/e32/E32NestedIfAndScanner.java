...
public class E32NestedIfAndScanner {
    public static void main(String[] args) {
        ...
        gender = input.next();// Capture the gender input
        ...
        if(age>25) {                                                    // If age is above 25
         if(gender.equalsIgnoreCase("F")) {                                              //    If gender is "F", print "Woman"
             System.out.println("Woman");
         }else {                                                        //    Otherwise, print "Man"
             System.out.println("Man");
         }
        }else if (age<=25){                                             // If age is 25 or below
            if(gender.equalsIgnoreCase("F")) {                                           //    If gender is "F", print "Girl"
